...
class Chirpify_Seller_Block_Campaign_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid
{
...
//         ));
  ...
  public function getSelectedProduct()
  {
    ...
    $campaign_product_id = $campaign->getProductId();
    if( !empty( $campaign_product_id ) )
    {
      //Mage::log("Yes getSelectedProduct: ");
      //Mage::log( $campaign_product_id );
      return array( $campaign_product_id );
    }
